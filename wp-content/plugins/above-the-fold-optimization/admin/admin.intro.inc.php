...
<div class="wrap abovethefold-wrapper">
	...
	<p style="font-size:14px;line-height:18px;">Beta versions of our new optimization plugins are slowly being published. The new plugins will replace this plugin in the future and we advise to use them for access to the latest technologies and long term support.</p>

	<p><a href="<?php print esc_url(add_query_arg(array('s' => 'o10n', 'tab' => 'search', 'type' => 'author'), admin_url('plugin-install.php'))); ?>" class="button button-large">View New Optimization Plugins</a></p>
    ...
    <p style="font-size:14px;line-height:18px;">A demo of instant navigation (as a WordPress plugin) can be viewed on <a href="https://www.e-scooter.co/" target="_blank">www.e-scooter.co</a> (bottom right link in the footer)<br /><br />
